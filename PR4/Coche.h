 ...
 */
#ifndef PR4STL_COCHE_H
#define PR4STL_COCHE_H
...
private:
    ...
    float bateria; ///< Nivel de batería del coche.
...
public:
     ...
     */
    [[nodiscard]]  std::string &getIdMatricula();
     ...
     */
    [[nodiscard]]  std::string &getModelo();
     ...
     */
    [[nodiscard]] PuntoRecarga *getPuntoRecarga();
     ...
     */
    friend std::ostream &operator<<(std::ostream &os, Coche &coche);

    /**
     * @brief Aparca el coche en un punto de recarga.
     *
     * Este método asigna un punto de recarga al coche.
     *
     * @param puntoRecarga1 Puntero al punto de recarga donde aparcar el coche.
     */
    void aparcar(PuntoRecarga *puntoRecarga1);

    /**
     * @brief Sobrecarga del operador de asignación.
     *
     * Asigna los valores de un coche a otro.
     *
     * @param rhs Coche del que se copian los valores.
     * @return Referencia al coche actual.
     */
    Coche &operator=(Coche &rhs);
};

#endif //PR4STL_COCHE_H

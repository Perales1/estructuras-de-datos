...
#ifndef PR6_REANELCAR_H
#define PR6_REANELCAR_H
...
private:
    ...
    MallaRegular<Coche *> mallaRegular;
...
public:
    ...
    */
    ...
    /**
     * @brief Devuelve un vector el vector de coches encontrados en un radio determinado de una
     * posición determinada
     * @param pos la posición desde la que se aplica la búsqueda en función del radio
     * @param radiokm el radio de kilómetros en los que buscar los coches
     * @return vector de coches según el radio de búsqueda de una posición determinada
     */
    std::vector<Coche *> buscarCochesRadio(UTM pos, float radiokm);

    /**
     * @brief Busca el coche mas cercano según una posición dada
     * @param pos la posición dada para buscar el coche más cercano a ella
     * @return el puntero al coche más cercano a la posición dada
     */
    Coche *buscarCocheMasCercano(UTM pos);

    /**
     * @brief Obtiene la malla de punteros de coches del sistema Reanelcar
     * @return la malla regular de punteros de coches obtenida del sistema Reanelcar
     */
    MallaRegular<Coche *> &getMallaRegular();

    /**
     * @brief setter de la malla regular de punteros de coches para el sistema reanelcar
     * @param mallaRegular la malla regular de punteros de coches a configurar
     */
    void setMallaRegular(MallaRegular<Coche *> &mallaRegular);
};


#endif //PR6_REANELCAR_H
